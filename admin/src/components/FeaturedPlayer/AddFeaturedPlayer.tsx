...
import FeaturedPlayerForm from './FeaturedPlayerForm';

const AddFeaturedPlayer: React.FC = () => {
    ...
    <>
      ...
      {isFormOpen && (
        ...
        >
          ...
          >
            <FeaturedPlayerForm closeForm={closeForm} />
          </div>
        </div>
      )}
      <Toaster />
...
export default AddFeaturedPlayer;
