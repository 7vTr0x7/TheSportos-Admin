...
import { handleForgotPassword, handleSignIn } from '../../firebase/auth';
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                <p className="hidden text-3xl text-white font-semibold dark:block ">
                  TheSportos
                </p>
                <p className="text-3xl text-black font-semibold dark:hidden">
                  TheSportos
                </p>
              </Link>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form>
                ...
                {/* Forgot Password */}
                <p className="mb-3 flex justify-end cursor-pointer text-blue-500 hover:text-blue-800">
                  Forgot password?
                </p>

                {error && (
                  <p className="text-red-500 mb-4">Invalid Credentials</p>
                )}
                <button
                  type="submit"
